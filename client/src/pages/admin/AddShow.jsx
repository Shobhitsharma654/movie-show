  ...
  return  nowPlayingMovies.length > 0 ?(
    ...
    <div className='overflow-x-auto pb-4'>
     ...
     {nowPlayingMovies.map((movie) =>(
      <div className={`relative max-w-40 cursor-pointer group-hover:not-hover:opacity-40 hover:-translate-y-1 transition duration-300`} key={movie.id} onClick={()=> setSelectedMovie(movie.id)}>
...
<button disabled={addingShow} onClick={handleSubmit} className='bg-primary text-white px-8 py-2 mt-6 rounded hover:bg-primary/90 transition-all cursor-pointer'>Add Show</button>
    </>
  ) : <Loading />
}
